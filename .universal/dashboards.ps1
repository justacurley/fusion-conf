# Homepage/Landing Page - Main entry point with navigation
...
# Individual Dashboard Apps (keep your existing structure)
...
New-PSUApp -Name "test" -FilePath "dashboards/test/test.ps1" -BaseUrl "/testme" -Environment "PowerShell 7" -AutoDeploy