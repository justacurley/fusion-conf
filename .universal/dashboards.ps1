New-PSUApp -Name "charts" -FilePath "dashboards/test/test.ps1" -BaseUrl "/charts" -Environment "PowerShell 7" -AutoDeploy -Description "charts" 
...
New-PSUApp -Name "HealthTimeline" -FilePath "dashboards/testb/testb.ps1" -BaseUrl "/timeline" -Environment "PowerShell 7" -AutoDeploy