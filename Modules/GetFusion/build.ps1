...
<#
.SYNOPSIS
    Build and test script for the GetFusion PowerShell module.

.DESCRIPTION
    This script provides common development tasks for the GetFusion module:
    - Running tests
...
<html>
<head>
    <title>GetFusion Module - Code Coverage Summary</title>
    <style>
...
<body>
    <div class="header">
        <h1>GetFusion Module - Code Coverage</h1>
...
# Main execution
Write-Host "GetFusion PowerShell Module Build Script" -ForegroundColor Magenta
