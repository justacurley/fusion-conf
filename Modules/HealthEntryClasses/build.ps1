...
<#
.SYNOPSIS
    Build and test script for the HealthEntryClasses PowerShell module.

.DESCRIPTION
    This script provides common development tasks for the HealthEntryClasses module:
    - Running tests
...
<html>
<head>
    <title>HealthEntryClasses Module - Code Coverage Summary</title>
    <style>
...
<body>
    <div class="header">
        <h1>HealthEntryClasses Module - Code Coverage</h1>
...
# Main execution
Write-Host "HealthEntryClasses PowerShell Module Build Script" -ForegroundColor Magenta
