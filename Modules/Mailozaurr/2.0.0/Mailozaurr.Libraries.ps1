if ($PSEdition -eq 'Core') {
    $LibrariesToLoad = @(
        ...
        'Lib\Core\EntityFramework.dll'
        'Lib\Core\EntityFramework.SqlServer.dll'
        ...
        'Lib\Core\System.Data.SQLite.dll'
        'Lib\Core\System.Data.SQLite.EF6.dll'
    ...
    $LibrariesToLoad = @(
        ...
        'Lib\Default\EntityFramework.dll'
        'Lib\Default\EntityFramework.SqlServer.dll'
        ...
        'Lib\Default\System.Data.SQLite.EF6.dll'
        'Lib\Default\System.Data.SQLite.Linq.dll'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAiIhzpBRBBXrXv
# pvPidUjesGZzTdQ9py5TqwOaQ3/ZJaCCJq4wggWNMIIEdaADAgECAhAOmxiO+dAt
...
# DQEJBDEiBCDXVvQcIABTaaOL4wlnEGRxkHrWFwt5HW9Nqmch5uA62TANBgkqhkiG
# 9w0BAQEFAASCAgARU5wfKI4lknU7FLZQBY2lDJqAi/OPU4SogaeReewYcSkti3FB
# kudOnCS3Cx5JhQIGiDMZup7xpUtnFxt1/fm0hfo7F03HO7vt+Iz9MVw3+sjGQb8s
# VgffSwp/0pP1rzAAVJaD1BJedvkMP27EF3EgFFRZdwSUGXypoG4urCeJISbRdFyA
# z0DcN9o+lT7HTI8MPiCXQmGWNPLZ8EohcbArF3dNoxarIP70olixp8FJJDxmr6Mw
# Zsp0PYY5r8i/TCDKYOgx7SitQsp2clrItBxdz4kEHg/LZ9/UKgfPUMnMwHCH+ruL
# /c3sQTSo+nRiP8LoA/5x1CPt9Hw32LKUtdfCCrClnK3JnjeXiPZ9cRtpW2AtQjE2
# jrAbl3aZcEDnI2daKG2avSha/zYX+8Hss6wt6A1QfitUzKR8oXVdywGR4hZQZ4ZX
# oCGZhT0GW/G7/7ebx6hs2RXdQb5MUojI9Dcz22et8AGytR/qlK+ytFWZBZGJojit
# rEqCqQS9TVx1XpZyBoA4oPY04P9SDWA7C6zTruTvY09V/OTEB+0TpqDVnSbd5YrV
# 5gIXcqEFqj5MoiA4P/2Yiui35k88fZ7PJmGAaAC4lyUPpoRiOdzVn1/81+1YqcPm
# e/e9ImoQDBEsE3LRkcjTqpMBVWWVwqcTtwmVHbzn96teP8y9J2SIluY8IqGCAyAw
...
# CSqGSIb3DQEJBTEPFw0yNTA3MDcxNTQ1MzdaMC8GCSqGSIb3DQEJBDEiBCCCPF2l
# Colm0M6nnTJLgGALeU/3MvF33f3lh4qH7UB/1DANBgkqhkiG9w0BAQEFAASCAgCC
# +EP2mr1uswVY0sGYyOCw1PGskP+9ptcIPyPtaKvP/38YTJQeUTivsEkCwNzdifE9
# AZanPhabhYoa8yD8x4UEJp7WkT2AwbRuiuswYscGnZCF8CC8gHemxgzHrS0ubneu
# nE/eS0uLZtynfFGnA782PkA94vBm1m/fdcjg+K2O6a8FnrQkc3UO+afg68TTJzZx
# sH1E1L6UmiI/TGyNOspbqYu28MtqSXE1WVuXkMFDUz2PH61M0H5Gh60SOAK5AKUk
# NjTLr5wAsntOd/SwbLAovEKW+q29du7tB8HqHUL7HuyjLKyhObaEBeIbT0OE/X7K
# ki0dmBkd8tpQps8NiHtAEDEWAKRiM6Rcr2nQ20Uaz/4Z54ZrvYX3YNpcWAfE/zk4
# sVFUWzphMOT1SA6yp0X1+rHh8oij6gnxl+Ghm7ix558hzZ7NUa2vUsqeiXBpiBQg
# FYJKrPTwaB3p8udfGRIApwk4GFRttNiwJsNfVNAXoGeAZ6hq62W5YjKXlKIPkVjD
# PjDCL0cOGuyhwWOCmP7Onu3GAkHMkRlYmCAujaPQ5dgfFYyEMNaf4L+yH65YVkmM
# Ivd2TtUKa7QZhh6fAJJZq6w4qmlfQsucMYnAJtBiXuiVdHwHK0vhBWvWhTpYXAx7
# 8moqjjZaqfaB2YPjsHAhyaTUBGiMQDPGYwSOTFxigQ==
