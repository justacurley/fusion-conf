New-UDApp -Content {
    New-UDContainer -Content {
        ...
        New-UDForm -Content {
            ...
            # Pain Section
            New-UDCard -Id "pain" -Content {
                New-UDTypography -Text "Pain" -Variant h6 -Style @{marginTop = "20px" }
                New-UDButton -Text "Add pain" -OnClick {
                    New-UDSelect -Id "pain" -Option {
                        New-UDSelectOption -Name "Back" -Value "Back"
                        New-UDSelectOption -Name "RHip" -Value "RHip"
                        New-UDSelectOption -Name "LHip" -Value "LHip"
                        New-UDSelectOption -Name "Quad" -Value "Quad"
                        New-UDSelectOption -Name "Glute" -Value "Glute"
                    }
                }
