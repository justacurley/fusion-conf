    ...
    New-UDContainer -Content {
        ...
        New-UDDynamic -Content {
            ...
            try {
                ...
                Set-UDCache -Key "chartData" -Value $combinedPainData
                ...
                $UpdateChart = {
                    ...
                    if ($showMaxPain) {
                        $datasets += New-UDChartJSDataset -DataProperty "MaxPainLevel" -Label "Max Pain Level" -BackgroundColor "#dc3545" -BorderColor "#dc3545" -AdditionalOptions @{
                            fill = $false
                            tension = 0.1
                            pointRadius = 4
                            borderWidth = 2
                    ...
                    if ($showBackPain) {
                        $datasets += New-UDChartJSDataset -DataProperty "AvgBackPain" -Label "Average Back Pain" -BackgroundColor "#007bff" -BorderColor "#007bff" -AdditionalOptions @{
                            fill = $false
                            tension = 0.1
                            pointRadius = 4
                            borderWidth = 2
                    ...
                    if ($showSleep) {
                        $datasets += New-UDChartJSDataset -DataProperty "SleepHours" -Label "Sleep Hours" -BackgroundColor "#28a745" -BorderColor "#28a745" -AdditionalOptions @{
                            fill = $false
                            tension = 0.1
                            pointRadius = 4
                            borderWidth = 2
                    ...
                    New-UDColumn -Size 12 -Content {
                        ...
                        New-UDElement -Id "dynamic_chart" -Tag "div" -Content {
                            ...
                            New-UDChartJS -Type 'line' -Data $combinedPainData -Dataset @(
                                New-UDChartJSDataset -DataProperty "MaxPainLevel" -Label "Max Pain Level" -BackgroundColor "#dc3545" -BorderColor "#dc3545" -AdditionalOptions @{
                                    fill = $false
                                    tension = 0.1
                                    pointRadius = 4
                                    borderWidth = 2
